...
const GYMS_LEADERS = [
    ...
    },  
    {
        ...
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Ghost.",
        team: {
    ...
    },
	{
        ...
        team: {
            ...
            slot4: pkmn.heracross, slot4Moves: [move.noRetreat.id, move.signalBeam.id, move.megahorn.id, move.attackOrder.id],
            slot5: pkmn.gallade, slot5Moves: [move.dynamicPunch.id, move.hiJumpKick.id, move.zenHeadbut.id, move.flyingPress.id],
            slot6: pkmn.medicham, slot6Moves: [move.noRetreat.id, move.zenHeadbut.id, move.hiJumpKick.id, move.thunderousKick.id],
        },
    }, 
	{
        ...
        description: "Especialista em Pokémon do tipo Water.",
        team: {
            slot1: pkmn.milotic, slot1Moves: [move.hydroCannon.id, move.scald.id, move.snipeShot.id, move.razorShell.id],
            slot2: pkmn.swampert, slot2Moves: [move.boneRush.id, move.sparklingAria.id, move.sandsearStorm.id, move.tripleDive.id],
            slot3: pkmn.gyarados, slot3Moves: [move.clamp.id, move.surf.id, move.scald.id, move.hydroCannon.id],
            slot4: pkmn.empoleon, slot4Moves: [move.anchorShot.id, move.clamp.id, move.gigatonHammer.id, move.tripleDive.id],
    ...
    },
	{
        ...
        team: {
            slot1: pkmn.gengar, slot1Moves: [move.moongeistBeam.id, move.toxic.id, move.phantomForce.id, move.venoshock.id],
            slot2: pkmn.dusknoir, slot2Moves: [move.shadowForce.id, move.rageFist.id, move.trickOrTreat.id, move.shadowBall.id],
            slot3: pkmn.mismagius, slot3Moves: [move.rageFist.id, move.shadowBall.id, move.trickOrTreat.id, move.mysticalPower.id],
            slot4: pkmn.banette, slot4Moves: [move.shadowForce.id, move.moongeistBeam.id, move.spectralThief.id, move.phantomForce.id],
            slot5: pkmn.drifblim, slot5Moves: [move.shadowBall.id, move.fly.id, move.shadowForce.id, move.acrobatics.id],
            slot6: pkmn.froslass, slot6Moves: [move.iceBall.id, move.shadowBall.id, move.glaciate.id, move.phantomForce.id],
        },
    },
	{
        ...
        description: "Especialista em Pokémon do tipo Steel.",
        team: {
            slot1: pkmn.metagross, slot1Moves: [move.psychic.id, move.kingsShield.id, move.zenHeadbut.id, move.shiftGear.id],
            slot2: pkmn.heatran, slot2Moves: [move.anchorShot.id, move.bitterBlade.id, move.ionise.id, move.overheat.id],
            slot3: pkmn.magnezone, slot3Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot4: pkmn.scizor, slot4Moves: [move.xScissor.id, move.silverWind.id, move.bugBuzz.id, move.struggleBug.id],
            slot5: pkmn.lucario, slot5Moves: [move.hiJumpKick.id, move.anchorShot.id, move.flyingPress.id, move.dynamicPunch.id],
            slot6: pkmn.dialga, slot6Moves: [move.anchorShot.id, move.roarOfTime.id, move.ionise.id, move.spacialRend.id],
        },
    },
	{
        ...
        description: "Especialista em Pokémon do tipo Ice.",
        team: {
            slot1: pkmn.weavile, slot1Moves: [move.iceBall.id, move.glaciate.id, move.iceHammer.id, move.freezeDry.id],
            slot2: pkmn.mamoswine, slot2Moves: [move.iceHammer.id, move.glaciate.id, move.freezeDry.id, move.foamShot.id],
            slot3: pkmn.glaceon, slot3Moves: [move.glaciate.id, move.iceHammer.id, move.mountainGale.id, move.freezeDry.id],
            slot4: pkmn.articuno, slot4Moves: [move.braveBird.id, move.glaciate.id, move.acrobatics.id, move.freezeDry.id],
    ...
    }, 
	{
        ...
        description: "Especialista em Pokémon do tipo Electric.",
        team: {
            slot1: pkmn.magnezone, slot1Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot2: pkmn.electivire, slot2Moves: [move.auraWheel.id, move.thunder.id, move.boltStrike.id, move.discharge.id],
            slot3: pkmn.luxray, slot3Moves: [move.ionise.id, move.voltTackle.id, move.boltStrike.id, move.auraWheel.id],
            slot4: pkmn.zapdos, slot4Moves: [move.zapCannon.id, move.zingZap.id, move.auraWheel.id, move.voltTackle.id],
            slot5: pkmn.jolteon, slot5Moves: [move.zapCannon.id, move.wildCharge.id, move.electroBall.id, move.voltTackle.id],
            slot6: pkmn.raikou, slot6Moves: [move.boltStrike.id, move.zingZap.id, move.voltTackle.id, move.thunderCage.id],
        },
    }, 
    ...
    },
	{
        ...
        description: "Especialista em Pokémon do tipo Normal.",
        team: {
            slot1: pkmn.slaking, slot1Moves: [move.beakBlast.id, move.relicSong.id, move.sketch.id, move.howl.id],
            slot2: pkmn.snorlax, slot2Moves: [move.relicSong.id, move.hyperDrill.id, move.beakBlast.id, move.crushGrip.id],
            slot3: pkmn.blissey, slot3Moves: [move.populationBomb.id, move.beakBlast.id, move.crushGrip.id, move.revelationDance.id],
            slot4: pkmn.stantler, slot4Moves: [move.noRetreat.id, move.howl.id, move.beakBlast.id, move.crushGrip.id],
            slot5: pkmn.porygonZ, slot5Moves: [move.conversion.id, move.nobleRoar.id, move.triAttack.id, move.sketch.id],
            slot6: pkmn.kangaskhan, slot6Moves: [move.howl.id, move.crushGrip.id, move.gigaImpact.id, move.beakBlast.id],
        },
    }, 
	{
        areaId: "vsGymLeaderBurgh",
        region: "unova",
        name: "Leader Burgh",
        city: "Castelia City",
        sprite: "burgh",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Bug.",
        team: {
            slot1: pkmn.scolipede, slot1Moves: [move.megahorn.id, move.quiverDance.id, move.xScissor.id, move.silverWind.id],
            slot2: pkmn.volcarona, slot2Moves: [move.xScissor.id, move.flamethrower.id, move.bugBuzz.id, move.brutalClaw.id],
            slot3: pkmn.scizor, slot3Moves: [move.xScissor.id, move.silverWind.id, move.bugBuzz.id, move.struggleBug.id],
            slot4: pkmn.heracross, slot4Moves: [move.noRetreat.id, move.signalBeam.id, move.megahorn.id, move.attackOrder.id],
            slot5: pkmn.pinsir, slot5Moves: [move.megahorn.id, move.quiverDance.id, move.xScissor.id, move.silverWind.id],
            slot6: pkmn.yanmega, slot6Moves: [move.megahorn.id, move.bite.id, move.signalBeam.id, move.bugBuzz.id],
        },
    }, 
	{
        areaId: "vsGymLeaderElesa",
        region: "unova",
        name: "Leader Elesa",
        city: "Nimbasa City",
        sprite: "elesa",
        ...
        description: "Especialista em Pokémon do tipo Electric.",
        team: {
            slot1: pkmn.zekrom, slot1Moves: [move.ionise.id, move.voltTackle.id, move.boltStrike.id, move.auraWheel.id],
            slot2: pkmn.electivire, slot2Moves: [move.auraWheel.id, move.thunder.id, move.zingZap.id, move.thunderPunch.id],
            slot3: pkmn.jolteon, slot3Moves: [move.zapCannon.id, move.wildCharge.id, move.electroBall.id, move.voltTackle.id],
            slot4: pkmn.zapdos, slot4Moves: [move.zapCannon.id, move.zingZap.id, move.auraWheel.id, move.voltTackle.id],
            slot5: pkmn.magnezone, slot5Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot6: pkmn.raikou, slot6Moves: [move.boltStrike.id, move.zingZap.id, move.voltTackle.id, move.thunderCage.id],
        },
    }, 
	{
        areaId: "vsGymLeaderClay",
        region: "unova",
        name: "Leader Clay",
        city: "Driftveil City",
        sprite: "clay",
        ...
        description: "Especialista em Pokémon do tipo Ground.",
        team: {
            slot1: pkmn.groudon, slot1Moves: [move.vCreate.id, move.sacredFire.id, move.brutalClaw.id, move.mindBlown.id],
            slot2: pkmn.garchomp, slot2Moves: [move.boneRush.id, move.sandsearStorm.id, move.earthquake.id, move.earthPower.id],
            slot3: pkmn.excadrill, slot3Moves: [move.dig.id, move.earthPower.id, move.earthquake.id, move.boneRush.id],
            slot4: pkmn.rhyperior, slot4Moves: [move.stoneEdge.id, move.rockTomb.id, move.thunder.id, move.earthquake.id],
            slot5: pkmn.mamoswine, slot5Moves: [move.earthPower.id, move.sandsearStorm.id, move.dig.id, move.boneRush.id],
            slot6: pkmn.landorus, slot6Moves: [move.sandsearStorm.id, move.earthquake.id, move.stoneEdge.id, move.earthPower.id],
        },
    }, 
	{
        areaId: "vsGymLeaderSkyla",
        region: "unova",
        name: "Leader Skyla",
    ...
    },
	{
        ...
        team: {
            ...
            slot2: pkmn.mamoswine, slot2Moves: [move.iceHammer.id, move.glaciate.id, move.freezeDry.id, move.foamShot.id],
            slot3: pkmn.weavile, slot3Moves: [move.iceBall.id, move.glaciate.id, move.iceHammer.id, move.freezeDry.id],
            slot4: pkmn.glaceon, slot4Moves: [move.glaciate.id, move.iceHammer.id, move.mountainGale.id, move.freezeDry.id],
            slot5: pkmn.lapras, slot5Moves: [move.iceBall.id, move.surf.id, move.glaciate.id, move.scald.id],
            slot6: pkmn.articuno, slot6Moves: [move.braveBird.id, move.glaciate.id, move.acrobatics.id, move.freezeDry.id],
        },
    },
	{
        areaId: "vsGymLeaderDrayden",
        region: "unova",
        name: "Leader Drayden",
        city: "Opelucid City",
        sprite: "drayden",
        ...
        team: {
            slot1: pkmn.rayquaza, slot1Moves: [move.roarOfTime.id, move.aeroblast.id, move.spacialRend.id, move.chatter.id],
            slot2: pkmn.garchomp, slot2Moves: [move.boneRush.id, move.sandsearStorm.id, move.earthquake.id, move.earthPower.id],
            slot3: pkmn.hydreigon, slot3Moves: [move.fieryWrath.id, move.dragonEnergy.id, move.darkestLariat.id, move.dragonDarts.id],
            slot4: pkmn.salamence, slot4Moves: [move.hurricane.id, move.spacialRend.id, move.aeroblast.id, move.roarOfTime.id],
            slot5: pkmn.dragonite, slot5Moves: [move.dragonAscent.id, move.roarOfTime.id, move.spacialRend.id, move.fly.id],
            slot6: pkmn.latios, slot6Moves: [move.kinesis.id, move.dragonDarts.id, move.lusterPurge.id, move.roarOfTime.id],
        },
    },

	//Kalos
	{
        areaId: "vsGymLeaderViola",
        region: "kalos",
        name: "Leader Viola",
        city: "Santalune City",
        sprite: "viola",
        ...
        description: "Especialista em Pokémon do tipo Bug.",
        team: {
            slot1: pkmn.forretress, slot1Moves: [move.quiverDance.id, move.xScissor.id, move.attackOrder.id, move.silverWind.id],
            slot2: pkmn.volcarona, slot2Moves: [move.xScissor.id, move.flamethrower.id, move.bugBuzz.id, move.brutalClaw.id],
            slot3: pkmn.scizor, slot3Moves: [move.xScissor.id, move.silverWind.id, move.bugBuzz.id, move.struggleBug.id],
            slot4: pkmn.heracross, slot4Moves: [move.noRetreat.id, move.signalBeam.id, move.megahorn.id, move.attackOrder.id],
            slot5: pkmn.pinsir, slot5Moves: [move.megahorn.id, move.quiverDance.id, move.xScissor.id, move.silverWind.id],
    ...
    },
	{
        ...
        team: {
            slot1: pkmn.tyranitar, slot1Moves: [move.clangingScales.id, move.ruination.id, move.fieryWrath.id, move.dragonDarts.id],
            slot2: pkmn.terrakion, slot2Moves: [move.meteorBeam.id, move.powerGem.id, move.rockSlide.id, move.smackDown.id],
            slot3: pkmn.rhyperior, slot3Moves: [move.stoneEdge.id, move.rockTomb.id, move.thunder.id, move.earthquake.id],
            slot4: pkmn.archeops, slot4Moves: [move.rockWrecker.id, move.stoneEdge.id, move.powerGem.id, move.rockSlide.id],
    ...
    },
	{
        ...
        description: "Especialista em Pokémon do tipo Grass.",
        team: {
            slot1: pkmn.victreebel, slot1Moves: [move.appleAcid.id, move.noxiousTorque.id, move.seedBomb.id, move.toxic.id],
            slot2: pkmn.ferrothorn, slot2Moves: [move.barrage.id, move.kingsShield.id, move.magicalLeaf.id, move.shiftGear.id],
            slot3: pkmn.sceptile, slot3Moves: [move.barrage.id, move.tropKick.id, move.chloroblast.id, move.magicalLeaf.id],
            slot4: pkmn.venusaur, slot4Moves: [move.seedFlare.id, move.toxic.id, move.cottonGuard.id, move.trailblaze.id],
            slot5: pkmn.torterra, slot5Moves: [move.boneRush.id, move.solarBeam.id, move.headlongRush.id, move.barrage.id],
            slot6: pkmn.amoonguss, slot6Moves: [move.barbBarrage.id, move.seedFlare.id, move.poisonTail.id, move.chloroblast.id],
        },
    },
	{
        areaId: "vsGymLeaderClemont",
        region: "kalos",
        name: "Leader Clemont",
        city: "Lumiose City",
        sprite: "clemont",
        ...
        team: {
            slot1: pkmn.zekrom, slot1Moves: [move.ionise.id, move.voltTackle.id, move.boltStrike.id, move.auraWheel.id],
            slot2: pkmn.thundurus, slot2Moves: [move.auraWheel.id, move.thunder.id, move.zingZap.id, move.thunderPunch.id],
            slot3: pkmn.magnezone, slot3Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot4: pkmn.rotomWash, slot4Moves: [move.surf.id, move.voltTackle.id, move.sparklingAria.id, move.boltStrike.id],
            slot5: pkmn.zapdos, slot5Moves: [move.zapCannon.id, move.zingZap.id, move.auraWheel.id, move.voltTackle.id],
            slot6: pkmn.raikou, slot6Moves: [move.boltStrike.id, move.zingZap.id, move.voltTackle.id, move.thunderCage.id],
        },
    }, 
	{
        areaId: "vsGymLeaderValerie",
        region: "kalos",
        name: "Leader Valerie",
        city: "Laverre City",
        sprite: "valerie",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Fairy.",
        team: {
            slot1: pkmn.xerneas, slot1Moves: [move.lightOfRuin.id, move.dazzlingGleam.id, move.moonblast.id, move.playRough.id],
            slot2: pkmn.togekiss, slot2Moves: [move.charm.id, move.dazzlingGleam.id, move.chatter.id, move.dragonAscent.id],
            slot3: pkmn.gardevoir, slot3Moves: [move.lightScreen.id, move.sweetKiss.id, move.moonblast.id, move.auroraPunch.id],
            slot4: pkmn.sylveon, slot4Moves: [move.charm.id, move.lightOfRuin.id, move.playRough.id, move.dazzlingGleam.id],
            slot5: pkmn.clefable, slot5Moves: [move.sweetKiss.id, move.lightOfRuin.id, move.moonblast.id, move.auroraPunch.id],
            slot6: pkmn.azumarill, slot6Moves: [move.sparklingAria.id, move.auroraPunch.id, move.surf.id, move.playRough.id],
        },
    }, 
	{
        areaId: "vsGymLeaderOlympia",
        region: "kalos",
        name: "Leader Olympia",
        city: "Anistar City",
        sprite: "olympia",
        ...
        description: "Especialista em Pokémon do tipo Psychic.",
        team: {
            slot1: pkmn.mewtwo, slot1Moves: [move.calmMind.id, move.psychic.id, move.shadowBall.id, move.zenHeadbut.id],
            slot2: pkmn.espeon, slot2Moves: [move.amnesia.id, move.mistBall.id, move.psybeam.id, move.prismaticLaser.id],
            slot3: pkmn.metagross, slot3Moves: [move.psychic.id, move.kingsShield.id, move.zenHeadbut.id, move.shiftGear.id],
            slot4: pkmn.alakazam, slot4Moves: [move.amnesia.id, move.psychic.id, move.twinBeam.id, move.kinesis.id],
            slot5: pkmn.gardevoir, slot5Moves: [move.kinesis.id, move.mistBall.id, move.luminaCrash.id, move.lunarDance.id],
            slot6: pkmn.reuniclus, slot6Moves: [move.kinesis.id, move.confusion.id, move.futureSight.id, move.psybeam.id],
        },
    },
	{
        areaId: "vsGymLeaderWulfric",
        region: "kalos",
        name: "Leader Wulfric",
        city: "Snowbelle City",
        sprite: "wulfric",
        ...
        team: {
            ...
            slot3: pkmn.weavile, slot3Moves: [move.iceBall.id, move.glaciate.id, move.iceHammer.id, move.freezeDry.id],
            slot4: pkmn.articuno, slot4Moves: [move.braveBird.id, move.glaciate.id, move.acrobatics.id, move.freezeDry.id],
            slot5: pkmn.glaceon, slot5Moves: [move.glaciate.id, move.iceHammer.id, move.mountainGale.id, move.freezeDry.id],
            slot6: pkmn.avalugg, slot6Moves: [move.iceBall.id, move.surf.id, move.glaciate.id, move.scald.id],
        },
    },

	//Alola
	{
        areaId: "vsGymLeaderHala",
        region: "alola",
        name: "Leader Hala",
    ...
    }, 
	{
        ...
        team: {
            ...
            slot2: pkmn.terrakion, slot2Moves: [move.meteorBeam.id, move.powerGem.id, move.rockSlide.id, move.smackDown.id],
            slot3: pkmn.rhyperior, slot3Moves: [move.stoneEdge.id, move.rockTomb.id, move.thunder.id, move.earthquake.id],
            slot4: pkmn.onix, slot4Moves: [move.rockWrecker.id, move.stoneEdge.id, move.powerGem.id, move.rockSlide.id],
            slot5: pkmn.aerodactyl, slot5Moves: [move.rockPolish.id, move.smackDown.id, move.fly.id, move.ancientPower.id],
            slot6: pkmn.gigalith, slot6Moves: [move.stoneEdge.id, move.megahorn.id, move.rockWrecker.id, move.stringShot.id],
        },
    },
	{
        areaId: "vsGymLeaderNanu",
        region: "alola",
        name: "Leader Nanu",
        city: "UlaUla Island",
        sprite: "nanu",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Dark.",
        team: {
            slot1: pkmn.yveltal, slot1Moves: [move.fieryWrath.id, move.darkestLariat.id, move.ruination.id, move.falseSurrender.id],
            slot2: pkmn.hydreigon, slot2Moves: [move.fieryWrath.id, move.dragonEnergy.id, move.darkestLariat.id, move.dragonDarts.id],
            slot3: pkmn.tyranitar, slot3Moves: [move.clangingScales.id, move.ruination.id, move.fieryWrath.id, move.dragonDarts.id],
            slot4: pkmn.greninja, slot4Moves: [move.waterShuriken.id, move.ruination.id, move.clamp.id, move.darkestLariat.id],
            slot5: pkmn.weavile, slot5Moves: [move.iceBall.id, move.glaciate.id, move.iceHammer.id, move.freezeDry.id],
            slot6: pkmn.absol, slot6Moves: [move.embargo.id, move.fieryWrath.id, move.falseSurrender.id, move.darkestLariat.id],
        },
    },
	{
        areaId: "vsGymLeaderHapu",
        region: "alola",
        name: "Leader Hapu",
        city: "Poni Island",
        sprite: "hapu",
        ...
        team: {
            slot1: pkmn.groudon, slot1Moves: [move.vCreate.id, move.sacredFire.id, move.brutalClaw.id, move.mindBlown.id],
            slot2: pkmn.garchomp, slot2Moves: [move.boneRush.id, move.sandsearStorm.id, move.earthquake.id, move.earthPower.id],
            slot3: pkmn.landorus, slot3Moves: [move.earthPower.id, move.earthquake.id, move.highHorsepower.id, move.sandsearStorm.id],
            slot4: pkmn.excadrill, slot4Moves: [move.dig.id, move.earthPower.id, move.earthquake.id, move.boneRush.id],
            slot5: pkmn.rhyperior, slot5Moves: [move.stoneEdge.id, move.rockTomb.id, move.thunder.id, move.earthquake.id],
            slot6: pkmn.mamoswine, slot6Moves: [move.earthPower.id, move.sandsearStorm.id, move.dig.id, move.boneRush.id],
        },
    },
	{
        areaId: "vsGymLeaderIlima",
        region: "alola",
        name: "Leader Ilima",
        city: "Melemele Island",
        sprite: "ilima",
        ...
        team: {
            slot1: pkmn.miltank, slot1Moves: [move.hyperDrill.id, move.triAttack.id, move.relicSong.id, move.howl.id],
            slot2: pkmn.slaking, slot2Moves: [move.beakBlast.id, move.relicSong.id, move.sketch.id, move.howl.id],
            slot3: pkmn.snorlax, slot3Moves: [move.relicSong.id, move.hyperDrill.id, move.beakBlast.id, move.crushGrip.id],
            slot4: pkmn.blissey, slot4Moves: [move.populationBomb.id, move.beakBlast.id, move.crushGrip.id, move.revelationDance.id],
            slot5: pkmn.porygonZ, slot5Moves: [move.conversion.id, move.nobleRoar.id, move.triAttack.id, move.sketch.id],
            slot6: pkmn.kangaskhan, slot6Moves: [move.howl.id, move.crushGrip.id, move.gigaImpact.id, move.beakBlast.id],
        },
    },
	{
        areaId: "vsGymLeaderLana",
        region: "alola",
        name: "Leader Lana",
        city: "Akala Island",
        sprite: "lana",
        ...
        team: {
            slot1: pkmn.kyogre, slot1Moves: [move.sparklingAria.id, move.snipeShot.id, move.tripleDive.id, move.razorShell.id],
            slot2: pkmn.palkia, slot2Moves: [move.dragonAscent.id, move.snipeShot.id, move.spacialRend.id, move.hydroCannon.id],
            slot3: pkmn.greninja, slot3Moves: [move.waterShuriken.id, move.ruination.id, move.clamp.id, move.darkestLariat.id],
            slot4: pkmn.swampert, slot4Moves: [move.boneRush.id, move.sparklingAria.id, move.sandsearStorm.id, move.tripleDive.id],
            slot5: pkmn.milotic, slot5Moves: [move.hydroCannon.id, move.scald.id, move.snipeShot.id, move.razorShell.id],
            slot6: pkmn.starmie, slot6Moves: [move.waterShuriken.id, move.aquaStep.id, move.surf.id, move.sparklingAria.id],
        },
    }, 
	{
        areaId: "vsGymLeaderKiawe",
        region: "alola",
        name: "Leader Kiawe",
        city: "Wela Volcano",
        sprite: "kiawe",
        ...
        description: "Especialista em Pokémon do tipo Fire.",
        team: {
            slot1: pkmn.reshiram, slot1Moves: [move.fireBlast.id, move.flameBurst.id, move.vCreate.id, move.flamethrower.id],
            slot2: pkmn.hooh, slot2Moves: [move.dragonAscent.id, move.chatter.id, move.fieryDance.id, move.braveBird.id],
            slot3: pkmn.volcarona, slot3Moves: [move.xScissor.id, move.flamethrower.id, move.bugBuzz.id, move.brutalClaw.id],
            slot4: pkmn.blaziken, slot4Moves: [move.bitterBlade.id, move.thunderousKick.id, move.vCreate.id, move.dynamicPunch.id],
            slot5: pkmn.charizard, slot5Moves: [move.flamethrower.id, move.flameBurst.id, move.brutalClaw.id, move.bitterBlade.id],
            slot6: pkmn.arcanine, slot6Moves: [move.fireFang.id, move.fireSpin.id, move.flamethrower.id, move.flareBlitz.id],
        },
    },
		{
        areaId: "vsGymLeaderMallow",
        region: "alola",
        name: "Leader Mallow",
        city: "Akala Island",
        sprite: "mallow",
	...
	{
        areaId: "vsGymLeaderSophocles",
        region: "alola",
        name: "Leader Sophocles",
        city: "UlaUla",
        sprite: "sophocles",
        background: "gym",
        level: 100,
        ...
        team: {
            slot1: pkmn.zekrom, slot1Moves: [move.ionise.id, move.voltTackle.id, move.boltStrike.id, move.auraWheel.id],
            slot2: pkmn.raikou, slot2Moves: [move.boltStrike.id, move.zingZap.id, move.voltTackle.id, move.thunderCage.id],
            slot3: pkmn.thundurus, slot3Moves: [move.auraWheel.id, move.thunder.id, move.zingZap.id, move.thunderPunch.id],
            slot4: pkmn.magnezone, slot4Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot5: pkmn.electivire, slot5Moves: [move.auraWheel.id, move.thunder.id, move.zingZap.id, move.thunderPunch.id],
            slot6: pkmn.zapdos, slot6Moves: [move.zapCannon.id, move.zingZap.id, move.auraWheel.id, move.voltTackle.id],
        },
    },
	{
        areaId: "vsGymLeaderAcerola",
        region: "alola",
        name: "Leader Acerola",
        city: "UlaUla",
        sprite: "acerola",
        ...
        description: "Especialista em Pokémon do tipo Ghost.",
        team: {
            slot1: pkmn.trevenant, slot1Moves: [move.seedFlare.id, move.shadowForce.id, move.tropKick.id, move.rageFist.id],
            slot2: pkmn.gengar, slot2Moves: [move.moongeistBeam.id, move.toxic.id, move.phantomForce.id, move.venoshock.id],
            slot3: pkmn.aegislash, slot3Moves: [move.gearUp.id, move.phantomForce.id, move.rageFist.id, move.shiftGear.id],
            slot4: pkmn.chandelure, slot4Moves: [move.flamethrower.id, move.fireFang.id, move.fireBlast.id, move.fireSpin.id],
            slot5: pkmn.dusknoir, slot5Moves: [move.shadowForce.id, move.rageFist.id, move.trickOrTreat.id, move.shadowBall.id],
            slot6: pkmn.mimikyu, slot6Moves: [move.rageFist.id, move.shadowForce.id, move.phantomForce.id, move.lovelyKiss.id],
        },
    },
	{
        areaId: "vsGymLeaderMina",
        region: "alola",
        name: "Leader Mina",
        city: "Poni Island",
        sprite: "mina",
	...
	{
        areaId: "vsGymLeaderMolayne",
        region: "alola",
        name: "Leader Molayne",
        city: "Hokulani Observaory",
        sprite: "molayne",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Steel.",
        team: {
            slot1: pkmn.dialga, slot1Moves: [move.anchorShot.id, move.roarOfTime.id, move.ionise.id, move.spacialRend.id],
            slot2: pkmn.metagross, slot2Moves: [move.psychic.id, move.kingsShield.id, move.zenHeadbut.id, move.shiftGear.id],
            slot3: pkmn.heatran, slot3Moves: [move.anchorShot.id, move.bitterBlade.id, move.ionise.id, move.overheat.id],
            slot4: pkmn.magnezone, slot4Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot5: pkmn.excadrill, slot5Moves: [move.dig.id, move.earthPower.id, move.earthquake.id, move.boneRush.id],
            slot6: pkmn.aegislash, slot6Moves: [move.gearUp.id, move.phantomForce.id, move.rageFist.id, move.shiftGear.id],
        },
    }, 

	//Galar
	{
        areaId: "vsGymLeaderNessa",
        region: "galar",
        name: "Leader Nessa",
        city: "Hulbury City",
        sprite: "nessa",
        ...
        description: "Especialista em Pokémon do tipo Water.",
        team: {
            slot1: pkmn.palkia, slot1Moves: [move.dragonAscent.id, move.snipeShot.id, move.spacialRend.id, move.hydroCannon.id],
            slot2: pkmn.greninja, slot2Moves: [move.waterShuriken.id, move.ruination.id, move.clamp.id, move.darkestLariat.id],
            slot3: pkmn.swampert, slot3Moves: [move.boneRush.id, move.sparklingAria.id, move.sandsearStorm.id, move.tripleDive.id],
            slot4: pkmn.milotic, slot4Moves: [move.hydroCannon.id, move.scald.id, move.snipeShot.id, move.razorShell.id],
            slot5: pkmn.toxapex, slot5Moves: [move.hydroCannon.id, move.toxic.id, move.razorShell.id, move.venoshock.id],
            slot6: pkmn.kyogre, slot6Moves: [move.sparklingAria.id, move.snipeShot.id, move.tripleDive.id, move.razorShell.id],
        },
    }, 
	{
        areaId: "vsGymLeaderKabu",
        region: "galar",
        name: "Leader Kabu",
        city: "Motostoke City",
        sprite: "kabu",
        ...
        description: "Especialista em Pokémon do tipo Fire.",
        team: {
            slot1: pkmn.cinderace, slot1Moves: [move.flamethrower.id, move.fireFang.id, move.fireBlast.id, move.fireSpin.id],
            slot2: pkmn.volcarona, slot2Moves: [move.xScissor.id, move.flamethrower.id, move.bugBuzz.id, move.brutalClaw.id],
            slot3: pkmn.charizard, slot3Moves: [move.flamethrower.id, move.flameBurst.id, move.brutalClaw.id, move.bitterBlade.id],
            slot4: pkmn.blaziken, slot4Moves: [move.bitterBlade.id, move.thunderousKick.id, move.vCreate.id, move.dynamicPunch.id],
            slot5: pkmn.reshiram, slot5Moves: [move.fireBlast.id, move.flameBurst.id, move.vCreate.id, move.flamethrower.id],
            slot6: pkmn.arcanine, slot6Moves: [move.fireFang.id, move.fireSpin.id, move.flamethrower.id, move.flareBlitz.id],
        },
    }, 
	{
        areaId: "vsGymLeaderBea",
        region: "galar",
        name: "Leader Bea",
        city: "StowOnSide City",
        sprite: "bea",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Fighting.",
        team: {
            ...
            slot5: pkmn.machamp, slot5Moves: [move.dynamicPunch.id, move.hiJumpKick.id, move.thunderousKick.id, move.focusBlast.id],
            slot6: pkmn.hawlucha, slot6Moves: [move.noRetreat.id, move.dragonAscent.id, move.dynamicPunch.id, move.chatter.id],
        },
    },
	{
        areaId: "vsGymLeaderAllister",
        region: "galar",
        name: "Leader Allister",
        city: "StowOnSide City",
        sprite: "allister",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Ghost.",
        team: {
            slot1: pkmn.mismagius, slot1Moves: [move.rageFist.id, move.shadowBall.id, move.trickOrTreat.id, move.mysticalPower.id],
            slot2: pkmn.banette, slot2Moves: [move.shadowForce.id, move.moongeistBeam.id, move.spectralThief.id, move.phantomForce.id],
            slot3: pkmn.drifblim, slot3Moves: [move.shadowBall.id, move.fly.id, move.shadowForce.id, move.acrobatics.id],
            slot4: pkmn.froslass, slot4Moves: [move.iceBall.id, move.shadowBall.id, move.glaciate.id, move.phantomForce.id],
            slot5: pkmn.dusknoir, slot5Moves: [move.shadowForce.id, move.rageFist.id, move.trickOrTreat.id, move.shadowBall.id],
            slot6: pkmn.gengar, slot6Moves: [move.moongeistBeam.id, move.toxic.id, move.phantomForce.id, move.venoshock.id],
        },
    },	
	{
        areaId: "vsGymLeaderOpal",
        region: "galar",
        name: "Leader Opal",
        city: "Ballonlea City",
        sprite: "opal",
        ...
        description: "Especialista em Pokémon do tipo Fairy.",
        team: {
            slot1: pkmn.zacian, slot1Moves: [move.lightOfRuin.id, move.auroraPunch.id, move.dazzlingGleam.id, move.moonblast.id],
            slot2: pkmn.togekiss, slot2Moves: [move.charm.id, move.dazzlingGleam.id, move.chatter.id, move.dragonAscent.id],
            slot3: pkmn.gardevoir, slot3Moves: [move.lightScreen.id, move.sweetKiss.id, move.moonblast.id, move.auroraPunch.id],
            slot4: pkmn.clefable, slot4Moves: [move.sweetKiss.id, move.lightOfRuin.id, move.moonblast.id, move.auroraPunch.id],
            slot5: pkmn.sylveon, slot5Moves: [move.charm.id, move.lightOfRuin.id, move.playRough.id, move.dazzlingGleam.id],
            slot6: pkmn.xerneas, slot6Moves: [move.lightOfRuin.id, move.dazzlingGleam.id, move.moonblast.id, move.playRough.id],
        },
    }, 
	{
        areaId: "vsGymLeaderGordie",
        region: "galar",
        name: "Leader Gordie",
        city: "Circhester City",
        sprite: "gordie",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Rock.",
        team: {
            ...
            slot2: pkmn.terrakion, slot2Moves: [move.meteorBeam.id, move.powerGem.id, move.rockSlide.id, move.smackDown.id],
            slot3: pkmn.rhyperior, slot3Moves: [move.stoneEdge.id, move.rockTomb.id, move.thunder.id, move.earthquake.id],
            slot4: pkmn.gigalith, slot4Moves: [move.stoneEdge.id, move.megahorn.id, move.rockWrecker.id, move.stringShot.id],
            slot5: pkmn.archeops, slot5Moves: [move.rockWrecker.id, move.stoneEdge.id, move.powerGem.id, move.rockSlide.id],
            slot6: pkmn.coalossal, slot6Moves: [move.flamethrower.id, move.stoneEdge.id, move.vCreate.id, move.rockWrecker.id],
        },
    }, 
	{
        areaId: "vsGymLeaderMelony",
        region: "galar",
        name: "Leader Melony",
        city: "Circhester City",
        sprite: "melony",
	...
	{
        areaId: "vsGymLeaderRaihan",
        region: "galar",
        name: "Leader Raihan",
        city: "Hammerlocke City",
        sprite: "raihan",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Dragon.",
        team: {
            slot1: pkmn.dragapult, slot1Moves: [move.shadowForce.id, move.dragonAscent.id, move.spectralThief.id, move.spacialRend.id],
            slot2: pkmn.garchomp, slot2Moves: [move.boneRush.id, move.sandsearStorm.id, move.earthquake.id, move.earthPower.id],
            slot3: pkmn.dragonite, slot3Moves: [move.dragonAscent.id, move.roarOfTime.id, move.spacialRend.id, move.fly.id],
            slot4: pkmn.salamence, slot4Moves: [move.hurricane.id, move.spacialRend.id, move.aeroblast.id, move.roarOfTime.id],
            slot5: pkmn.hydreigon, slot5Moves: [move.fieryWrath.id, move.dragonEnergy.id, move.darkestLariat.id, move.dragonDarts.id],
            slot6: pkmn.rayquaza, slot6Moves: [move.roarOfTime.id, move.aeroblast.id, move.spacialRend.id, move.chatter.id],
        },
    }, 
	{
        areaId: "vsGymLeaderMilo",
        region: "galar",
        name: "Leader Milo",
        city: "Turffield City",
        sprite: "milo",
        ...
        description: "Especialista em Pokémon do tipo Grass.",
        team: {
            slot1: pkmn.rillaboom, slot1Moves: [move.drumBeating.id, move.trailblaze.id, move.chloroblast.id, move.razorLeaf.id],
            slot2: pkmn.ferrothorn, slot2Moves: [move.barrage.id, move.kingsShield.id, move.magicalLeaf.id, move.shiftGear.id],
            slot3: pkmn.venusaur, slot3Moves: [move.seedFlare.id, move.toxic.id, move.cottonGuard.id, move.trailblaze.id],
            slot4: pkmn.tangrowth, slot4Moves: [move.seedBomb.id, move.leafage.id, move.razorLeaf.id, move.tropKick.id],
            slot5: pkmn.kartana, slot5Moves: [move.barrage.id, move.tropKick.id, move.chloroblast.id, move.magicalLeaf.id],
            slot6: pkmn.amoonguss, slot6Moves: [move.barbBarrage.id, move.seedFlare.id, move.poisonTail.id, move.chloroblast.id],
        },
    },
	...
	//Paldea
	{
        ...
        description: "Especialista em Pokémon do tipo Bug.",
        team: {
            slot1: pkmn.slitherWing, slot1Moves: [move.megahorn.id, move.bite.id, move.signalBeam.id, move.bugBuzz.id],
            slot2: pkmn.volcarona, slot2Moves: [move.xScissor.id, move.flamethrower.id, move.bugBuzz.id, move.brutalClaw.id],
            slot3: pkmn.scolipede, slot3Moves: [move.megahorn.id, move.quiverDance.id, move.xScissor.id, move.silverWind.id],
            slot4: pkmn.scizor, slot4Moves: [move.xScissor.id, move.silverWind.id, move.bugBuzz.id, move.struggleBug.id],
            slot5: pkmn.heracross, slot5Moves: [move.noRetreat.id, move.signalBeam.id, move.megahorn.id, move.attackOrder.id],
            slot6: pkmn.pinsir, slot6Moves: [move.megahorn.id, move.quiverDance.id, move.xScissor.id, move.silverWind.id],
        },
    },
	{
        areaId: "vsGymLeaderBrassius",
        region: "paldea",
        name: "Leader Brassius",
        city: "Artazon City",
        sprite: "brassius",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Grass.",
        team: {
            slot1: pkmn.koraidon, slot1Moves: [move.seedBomb.id, move.trailblaze.id, move.barrage.id, move.tropKick.id],
            slot2: pkmn.rillaboom, slot2Moves: [move.drumBeating.id, move.trailblaze.id, move.chloroblast.id, move.razorLeaf.id],
            slot3: pkmn.ferrothorn, slot3Moves: [move.barrage.id, move.kingsShield.id, move.magicalLeaf.id, move.shiftGear.id],
            slot4: pkmn.venusaur, slot4Moves: [move.seedFlare.id, move.toxic.id, move.cottonGuard.id, move.trailblaze.id],
            slot5: pkmn.kartana, slot5Moves: [move.barrage.id, move.tropKick.id, move.chloroblast.id, move.magicalLeaf.id],
            slot6: pkmn.amoonguss, slot6Moves: [move.barbBarrage.id, move.seedFlare.id, move.poisonTail.id, move.chloroblast.id],
        },
    },
	{
        ...
        description: "Especialista em Pokémon do tipo Electric.",
        team: {
            slot1: pkmn.regieleki, slot1Moves: [move.auraWheel.id, move.thunder.id, move.zingZap.id, move.thunderPunch.id],
            slot2: pkmn.zekrom, slot2Moves: [move.ionise.id, move.voltTackle.id, move.boltStrike.id, move.auraWheel.id],
            slot3: pkmn.raikou, slot3Moves: [move.boltStrike.id, move.zingZap.id, move.voltTackle.id, move.thunderCage.id],
            slot4: pkmn.zapdos, slot4Moves: [move.zapCannon.id, move.zingZap.id, move.auraWheel.id, move.voltTackle.id],
            slot5: pkmn.magnezone, slot5Moves: [move.ionise.id, move.flashCannon.id, move.electroBall.id, move.thunder.id],
            slot6: pkmn.miraidon, slot6Moves: [move.zapCannon.id, move.wildCharge.id, move.electroBall.id, move.voltTackle.id],
        },
    }, 
	{
        areaId: "vsGymLeaderKofu",
        region: "paldea",
        name: "Leader Kofu",
        city: "Cascarrafa City",
        sprite: "kofu",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Ground.",
        team: {
            ...
            slot3: pkmn.greninja, slot3Moves: [move.waterShuriken.id, move.ruination.id, move.clamp.id, move.darkestLariat.id],
            slot4: pkmn.swampert, slot4Moves: [move.boneRush.id, move.sparklingAria.id, move.sandsearStorm.id, move.tripleDive.id],
            slot5: pkmn.dondozo, slot5Moves: [move.hydroCannon.id, move.scald.id, move.snipeShot.id, move.razorShell.id],
            slot6: pkmn.gyarados, slot6Moves: [move.clamp.id, move.surf.id, move.scald.id, move.hydroCannon.id],
        },
    },
	{
        areaId: "vsGymLeaderLarry",
        region: "paldea",
        name: "Leader Larry",
        city: "Medali City",
        sprite: "larry",
        ...
        team: {
            slot1: pkmn.miltank, slot1Moves: [move.hyperDrill.id, move.triAttack.id, move.relicSong.id, move.howl.id],
            slot2: pkmn.lugia, slot2Moves: [move.tripleDive.id, move.aeroblast.id, move.razorShell.id, move.chatter.id],
            slot3: pkmn.cyclizar, slot3Moves: [move.populationBomb.id, move.beakBlast.id, move.crushGrip.id, move.revelationDance.id],
            slot4: pkmn.staraptor, slot4Moves: [move.headCharge.id, move.fly.id, move.meFirst.id, move.braveBird.id],
            slot5: pkmn.braviary, slot5Moves: [move.howl.id, move.crushGrip.id, move.gigaImpact.id, move.beakBlast.id],
            slot6: pkmn.snorlax, slot6Moves: [move.relicSong.id, move.hyperDrill.id, move.beakBlast.id, move.crushGrip.id],
        },
    }, 
	{
        areaId: "vsGymLeaderRyme",
        region: "paldea",
        name: "Leader Ryme",
        city: "Montenevera City",
        sprite: "ryme",
        background: "gym",
        level: 100,
        description: "Especialista em Pokémon do tipo Ghost.",
        team: {
            slot1: pkmn.banette, slot1Moves: [move.shadowForce.id, move.moongeistBeam.id, move.spectralThief.id, move.phantomForce.id],
            slot2: pkmn.gengar, slot2Moves: [move.moongeistBeam.id, move.toxic.id, move.phantomForce.id, move.venoshock.id],
            slot3: pkmn.aegislash, slot3Moves: [move.gearUp.id, move.phantomForce.id, move.rageFist.id, move.shiftGear.id],
            slot4: pkmn.chandelure, slot4Moves: [move.flamethrower.id, move.fireFang.id, move.fireBlast.id, move.fireSpin.id],
            slot5: pkmn.dragapult, slot5Moves: [move.shadowForce.id, move.dragonAscent.id, move.spectralThief.id, move.spacialRend.id],
            slot6: pkmn.flutterMane, slot6Moves: [move.rageFist.id, move.shadowBall.id, move.trickOrTreat.id, move.mysticalPower.id],
        },
    },
	{
        areaId: "vsGymLeaderTulip",
        region: "paldea",
        name: "Leader Tulip",
        city: "Alfornada City",
        sprite: "tulip",
        ...
        team: {
            slot1: pkmn.mewtwo, slot1Moves: [move.calmMind.id, move.psychic.id, move.shadowBall.id, move.zenHeadbut.id],
            slot2: pkmn.starmie, slot2Moves: [move.waterShuriken.id, move.aquaStep.id, move.surf.id, move.sparklingAria.id],
            slot3: pkmn.metagross, slot3Moves: [move.psychic.id, move.kingsShield.id, move.zenHeadbut.id, move.shiftGear.id],
            slot4: pkmn.gardevoir, slot4Moves: [move.kinesis.id, move.mistBall.id, move.luminaCrash.id, move.lunarDance.id],
            slot5: pkmn.espathra, slot5Moves: [move.amnesia.id, move.mistBall.id, move.psybeam.id, move.prismaticLaser.id],
            slot6: pkmn.alakazam, slot6Moves: [move.amnesia.id, move.psychic.id, move.twinBeam.id, move.kinesis.id],
        },
    },
	{
        areaId: "vsGymLeaderGrusha",
        region: "paldea",
        name: "Leader Grusha",
        city: "Glaseado City",
        sprite: "grusha",
