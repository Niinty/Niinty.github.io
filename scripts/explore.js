...
function leaveCombat(){
    ...
    if ( areas[saved.currentArea]?.isLegendsBattle ) {
            ...
            Auto-Refight <span>(Costs <img src="img/items/bottleCap.png"> 20 Bottle Caps — have ${item.bottleCap.got})</span>
            `
        }
